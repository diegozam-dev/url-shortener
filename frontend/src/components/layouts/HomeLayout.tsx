      ...
      <main className="mx-auto px-6 max-w-[1032px] overflow-visible">
        ...
        <section id="about" className="py-16 z-50 flex flex-col items-center">
          ...
          <p className="text-(--text-primary) text-xl text-center max-w-[500px]">
            ...
            With just one click, it transforms long URLs into compact, shareable
            versions. Simply paste your link into the field, click "Shorten",
            and instantly get a short link ready to share with your friends.
          </p>
        </section>
      </main>
      <Footer />
